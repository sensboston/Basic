...
InitVars:
    ...
    ' Always use EGA mode 9 (640x350, 16 colors)
    Mode = 9
    SCREEN Mode
...
' Error handlers removed - always using Mode 9
...
SUB Intro
    ' Stay in graphics mode - don't switch to SCREEN 0
    MaxCol = 80
    COLOR 15, 0
    CLS
...
SUB PlayGame (Player1$, Player2$, NumGames)
    ...
    ' Stay in graphics mode for game over screen
    COLOR 7, 0
    MaxCol = 80
    CLS
